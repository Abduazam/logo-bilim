                ...
                <form wire:submit.prevent="create" class="form-border-radius">
                    <div class="block block-rounded shadow-none mb-0">
                        ...
                        <div class="block-content fs-sm">
                            <div class="row w-100 h-100 p-0 m-0">
                                <div class="col-6 ps-0 mb-4">
                                    ...
                                    <input wire:model.live="form.slug" type="text" class="form-control form-control-sm @error('form.slug') is-invalid @elseif(!empty($this->form->slug)) is-valid @enderror" id="slug" name="slug" placeholder="Slug">
                                    @error('form.slug')
                        ...
                        <div class="block-content block-content-full block-content-sm d-flex align-items-center justify-content-between border-top">
                            ...
                            <button wire:target="create" wire:loading.attr="disabled" type="submit" class="btn btn-sm btn-success">
                                Create
                            </button>
                        </div>
                    </div>
