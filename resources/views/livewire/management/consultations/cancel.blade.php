<div class="d-inline-block">
    <button type="button" class="btn btn-sm btn-danger text-white" data-bs-toggle="modal" data-bs-target="#modal-cancel-consultation-id{{ $this->consultation->id }}">
        <i class="far fa-calendar-xmark"></i>
    </button>

    <div wire:ignore.self class="modal fade" id="modal-cancel-consultation-id{{ $this->consultation->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-cancel-consultation-id{{ $this->consultation->id }}" aria-hidden="true">
                ...
                <form wire:submit.prevent="cancel" class="form-border-radius">
                    <div class="block block-rounded shadow-none mb-0">
                        <div class="block-header block-header-default">
                            <h3 class="block-title fs-sm mt-1">{{ trans('dashboard.actions.cancel') }} {{ strtolower(trans('dashboard.sections.consultation')) }}</h3>
