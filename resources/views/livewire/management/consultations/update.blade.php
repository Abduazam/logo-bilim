    ...
    <form wire:submit.prevent="update" class="w-100 position-relative">
        <div wire:ignore.self class="offcanvas offcanvas-end bg-body-extra-light w-40 shadow h-100" tabindex="-1" id="offcanvasConsultationUpdateId{{ $this->consultation->id }}" aria-labelledby="offcanvasConsultationUpdateId{{ $this->consultation->id }}Label" data-bs-backdrop="false">
            <div class="offcanvas-header bg-body-light">
                <h6 class="offcanvas-title" id="offcanvasConsultationUpdateId{{ $this->consultation->id }}Label">{{ trans('dashboard.actions.update') }} {{ strtolower(trans('dashboard.sections.consultation')) }}</h6>
                    ...
                    <div class="block-content overflow-hidden px-3 py-0">
                        ...
                        <div class="row w-100 p-0 m-0">
                            ...
                            <div class="col-md-6 ps-0">
                                <label for="start_time" class="form-label">{{ trans('dashboard.fields.start_time') }} <small class="text-muted">({{ $this->consultation->getStartTime() }})</small></label>
                            ...
                            <div class="col-md-6 pe-0">
                                <label for="end_time" class="form-label">{{ trans('dashboard.fields.end_time') }} <small class="text-muted">({{ $this->consultation->getEndTime() }})</small></label>
