                                    ...
                                    <div class="col-12 border rounded-3 p-3 mb-3 position-relative">
                                        <div class="row w-100 p-0 m-0">
                                            ...
                                            <div class="col-md-6 mb-2 pe-0">
                                                ...
                                                <input wire:model.live="form.payments.{{ $id }}.benefit" type="number" class="form-control form-control-sm w-100 @error('form.payments.' . $id . '.benefit') is-invalid @elseif(isNotNullAndNotEmptyString($this->form->payments[$id]['benefit']))) is-valid @enderror" id="benefit{{ $id }}" name="benefit{{ $id }}" placeholder="Benefit" disabled>
