    ...
    <form wire:submit.prevent="update" class="w-100 position-relative">
        <div wire:ignore.self class="offcanvas offcanvas-end bg-body-extra-light w-40 shadow h-100" tabindex="-1" id="offcanvasAppointmentUpdateId{{ $this->appointment->id }}" aria-labelledby="offcanvasAppointmentUpdateId{{ $this->appointment->id }}Label" data-bs-backdrop="false">
            <div class="offcanvas-header bg-body-light">
                <h6 class="offcanvas-title" id="offcanvasAppointmentUpdateId{{ $this->appointment->id }}Label">{{ trans('dashboard.actions.update') }} {{ strtolower(trans('dashboard.sections.appointment')) }}</h6>
                    ...
                    <div wire:ignore.self class="block-content overflow-hidden px-3">
                        <div class="fade @if($this->form->activeSection === 'registration') show @else d-none @endif">
                            <div class="row w-100 p-0 m-0">
                                ...
                                <div class="col-md-6 mb-3 ps-0">
                                    <label for="created_date" class="form-label">{{ trans('dashboard.fields.start_date') }}</label>
                                ...
                                <div class="col-md-6 mb-3 pe-0">
                                    <label for="start_time" class="form-label">{{ trans('dashboard.fields.start_time') }} <small class="text-muted">({{ $this->appointment->getStartTime() }})</small></label>
            ...
            <div class="offcanvas-footer bg-body-light p-3 w-100 text-start">
                ...
                <button wire:loading.attr="disabled" data-bs-dismiss="offcanvas" type="submit" class="btn btn-success border-0" @if($this->form->registrationForm && $this->form->paymentsForm) wire:target="update" @else disabled @endif>
                    <small>{{ trans('dashboard.actions.update') }}</small>
                </button>
            </div>
        </div>
    </form>
