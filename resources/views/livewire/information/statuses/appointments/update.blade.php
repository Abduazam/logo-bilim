<div class="d-inline-block">
    <button type="button" class="btn btn-sm btn-primary text-white" data-bs-toggle="modal" data-bs-target="#modal-update-appointment-status-id{{ $this->appointmentStatus->id }}">
        <i class="fa fa-pen"></i>
    </button>

    <div wire:ignore.self class="modal fade" id="modal-update-appointment-status-id{{ $this->appointmentStatus->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-update-appointment-status-id{{ $this->appointmentStatus->id }}" aria-hidden="true">
                ...
                <form wire:submit.prevent="update" class="form-border-radius">
                    <div class="block block-rounded shadow-none mb-0">
                        <div class="block-header block-header-default">
                            <h3 class="block-title fs-sm mt-1">{{ trans('dashboard.sections.statuses-appointment') }} {{ strtolower(trans('dashboard.actions.update')) }}</h3>
