<div class="d-inline-block">
    <button type="button" class="btn btn-sm btn-danger text-white" data-bs-toggle="modal" data-bs-target="#modal-delete-appointment-status-id{{ $this->appointmentStatus->id }}">
        <i class="fa fa-trash"></i>
    </button>

    <div wire:ignore.self class="modal fade" id="modal-delete-appointment-status-id{{ $this->appointmentStatus->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-delete-appointment-status-id{{ $this->appointmentStatus->id }}" aria-hidden="true">
                ...
                <form wire:submit.prevent="delete" class="form-border-radius">
                    <div class="block block-rounded shadow-none mb-0">
                        <div class="block-header block-header-default">
                            <h3 class="block-title fs-sm mt-1">Delete appointment status</h3>
