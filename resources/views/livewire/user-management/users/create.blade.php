                ...
                <div class="block block-rounded">
                    <div class="block-content fs-sm">
                        ...
                        <div class="row w-100 h-100 p-0 mx-0 mb-4 align-items-center">
                            ...
                            <div class="col-8">
                                <select wire:model.blur="branch_id" wire:change="addBranch($event.target.value)" class="form-select form-select-sm w-75 @error('form.chosen_branches') is-invalid @elseif(!is_null($this->branch_id)) is-valid @enderror" name="branch_id" id="branch_id">
                                    <option value="null" disabled>Choose</option>
