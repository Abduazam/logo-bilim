<div class="d-inline-block">
    <button type="button" class="btn btn-sm btn-info text-white" data-bs-toggle="modal" data-bs-target="#modal-restore-user-id{{ $user->id }}">
        <i class="fa fa-rotate-left"></i>
    </button>

    <div wire:ignore.self class="modal fade" id="modal-restore-user-id{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-restore-user-id{{ $user->id }}" aria-hidden="true">
